function VXversusU(fname,refFile,type,timeStep)
...
%     end
    ...
    if abs(xvel(ind)/allSpd(ind))>threshold
        i=i+1;
...
figure(1)
hist(xvel./allSpd)
title('distribution of Vx/U')
no=sum(abs(xvel./allSpd)>0.6)
